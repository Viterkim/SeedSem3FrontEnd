...
It has been changed to serve as a demo frontend for a matching Java (JAX-RS) backend and are meant ONLY for exercises at:
...
* Clone *this* project and:
  ...
  - start it (with a local development server) via: ```npm start```
...
## Information below is from the originally README.md generated by create-react-app.
